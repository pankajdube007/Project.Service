...
{
    public class TotalSaleDivisionWiseManagementAction
    {
        [Required]
    ...
    public class TotalSaleDivisionWiseManagements
    {
        public bool result { get; set; }
        public string message { get; set; }
        public string servertime { get; set; }
        public List<TotalSaleDivisionWiseManagementFinal> data { get; set; }
    }

    public class TotalSaleDivisionWiseManagementFinal
    {
        public List<TotalSaleDivisionWiseManagement> saledetails { get; set; }
        public TotalSaleDivisionWiseManagementTotal saledetailsTotal { get; set; }
        public bool ismore { get; set; }
    }

    public class TotalSaleDivisionWiseManagement
    {
    ...
    public class TotalSaleDivisionWiseManagementTotal
    {
