...
{
    public class ActionResultPartyDummyVendor
    {
        [Required]
    ...
    public class UserValidationPartyDummyVendor
    {
        public class UserInfoDummyVendor
        {
            public bool result { get; set; }
            public string message { get; set; }
            public string servertime { get; set; }
            public UsersDummyVendor data { get; set; }
        }

        public class UsersDummyVendor
        {
