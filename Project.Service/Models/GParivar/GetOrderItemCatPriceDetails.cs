...
namespace Project.Service.Models
{
    ...
    public class ListofGetOrderItemCatPriceDetails
    {
        [Required]
    ...
    public class GetOrderItemCatPriceDetailss
    {
        public bool result { get; set; }
        public string message { get; set; }
        public string servertime { get; set; }
        public List<GetOrderItemCatPriceDetails> data { get; set; }
    }

    public class GetOrderItemCatPriceDetails
    {
