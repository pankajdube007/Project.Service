...
namespace Project.Service.Models
{
    ...
    public class ListofGetItemDetailsByItemCode
    {
        [Required]
    ...
    public class GetItemDetailsByItemCodeLists
    {
        public bool result { get; set; }
        public string message { get; set; }
        public string servertime { get; set; }
        public List<GetItemDetailsByItemCodeList> data { get; set; }
    }

    public class GetItemDetailsByItemCodeList
    {
