...
namespace Project.Service.Models
{
    ...
    public class ListofItemDetailsByCategoryAndNameOrCode
    {
        [Required]
    ...
    public class ItemDetailsByCategoryAndNameOrCodeLists
    {
        public bool result { get; set; }
        public string message { get; set; }
        public string servertime { get; set; }
        public List<ItemDetailsByCategoryAndNameOrCodeList> data { get; set; }
    }

    public class ItemDetailsByCategoryAndNameOrCodeList
    {
