...
{
    public class ListExecSchemeWiseTarget
    {
        [Required]
    ...
    public class ExecSchemeWiseTarget
    {
        public bool result { get; set; }
        public string message { get; set; }
        public string servertime { get; set; }
        public List<ExecSchemeWiseTargets> data { get; set; }
    }

    public class ExecSchemeWiseTargets
    {
