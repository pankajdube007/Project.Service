...
{
    public class Branchwiseitemwisestockvalueandageingmanagement
    {
        [Required]
    ...
    public class BranchwiseitemwisestockvalueandageingmanagementLists
    {
        public bool result { get; set; }
        public string message { get; set; }
        public string servertime { get; set; }
        public List<BranchwiseitemwisestockvalueandageingmanagementList> data { get; set; }
    }

    public class BranchwiseitemwisestockvalueandageingmanagementList
    {
