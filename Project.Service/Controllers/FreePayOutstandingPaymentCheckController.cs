...
{
    public class FreePayOutstandingPaymentCheckController : ApiController
    {
        [HttpPost]
        [ValidateModel]
        [Route("api/CheckOutstandingPaymentDetails")]
        public HttpResponseMessage GetDetails(ListofFreePayOutstandingPayment ula)
        {
            ...
            try
            {
                ...
                var drcheck = g2.return_dr("currentopentransaction '"+ula.CIN+"'");
                ...
                else
                {
                    ...
                    var dr = g2.return_dt("sp_customerreceiptaddFreePay '"
                        + ula.CIN + "','"
                        + ula.grandtotal + "','"
                    ...
                    if (dr.Rows.Count > 0)
                    {
                        var dr1 = g2.return_dr("sp_customerreceiptaddInvoiceFreePay " + dr.Rows[0]["slno"].ToString());
