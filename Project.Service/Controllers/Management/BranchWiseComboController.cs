...
{
    public class BranchWiseComboController : ApiController
    {
        [HttpPost]
        [ValidateModel]
        [Route("api/Getbranchwisecombo")]
        public HttpResponseMessage GetDetails(ListofBranchWiseCombo ula)
        {
            ...
            if (ula.CIN != "")
            {
                try
                {
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        g1.close_connection();
                        alldcr.Add(new BranchWiseCombos
                        {
                            result = true,
