...
{
    public class EinvoiceCancelAdaequareController : ApiController
    {
        [HttpPost]
        [ValidateModel]
        [Route("api/CancelEInvoiceBillAda")]
                ...
                try
                {
                    ...
                    if (key != "" && dr3.Rows.Count > 0)
                    {
                        ...
                        if (dr5.Rows.Count > 0)
                        {
                            ...
                            var baseurl = ConfigurationManager.AppSettings["Gold.Eway.EAPI"] + "invoice/cancel";
                            ...
                            if (response1.StatusCode == System.Net.HttpStatusCode.OK)
                            {
                                ...
                                if (_output.success = true && _output.message == "E-Invoice is cancelled successfully")
                                {
                                    ...
                                    if (dr1.HasRows)
                                    {
                                        ...
                                        response.Content = new StringContent(cm.StatusTime(true, "EInvoiceBill Cancelled!!!"), Encoding.UTF8, "application/json");
