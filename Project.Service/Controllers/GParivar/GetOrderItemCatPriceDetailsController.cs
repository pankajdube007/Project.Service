...
{
    public class GetOrderItemCatPriceDetailsController : ApiController
    {
        ...
        [Route("api/getOrderItemCatPriceDetailList")]
        public HttpResponseMessage GetDetails(ListofGetOrderItemCatPriceDetails ula)
        {
            ...
            if (ula.CIN != "")
            {
                try
                {
                    ...
                    List<GetOrderItemCatPriceDetailss> alldcr = new List<GetOrderItemCatPriceDetailss>();
                    List<GetOrderItemCatPriceDetails> alldcr1 = new List<GetOrderItemCatPriceDetails>();
                    var dr = g1.return_dr("AppItemCatalogePriceDetailList '" + ula.CIN + "','" + ula.ItemCode + "','" + ula.ItemName + "'");

                    if (dr.HasRows)
                    {
                        while (dr.Read())
                        {
                            alldcr1.Add(new GetOrderItemCatPriceDetails
                            {
                        ...
                        g1.close_connection();
                        alldcr.Add(new GetOrderItemCatPriceDetailss
                        {
                            result = true,
