        ...
        public HttpResponseMessage GetDetails(ListsofFreepayOutstandingReport ula)
        {
            ...
            if (ula.CIN != null)
            {
                try
                {
                    ...
                    var dr = g1.return_dt("AppFreepayOutstandingReport '" + ula.CIN + "'," + ula.Division + "," + ula.OutstangingDays + "," + ula.Index + "," + ula.Count + "," + ula.PayType);
                    bool more = false;
                    ...
                    if (dr.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dr.Rows.Count; i++)
                        {
                            alldcr1.Add(new FreepayOutstandingReport
                            {
                                ...
                                days = Convert.ToInt32(dr.Rows[i]["day1"].ToString()),
                            });
                        }
                        ...
                        var dttotalsum = g1.return_dt("AppFreepayOutstandingReport '" + ula.CIN + "'," + ula.Division + "," + ula.OutstangingDays + "," + 0 + "," + 999999 + "," + ula.PayType);
