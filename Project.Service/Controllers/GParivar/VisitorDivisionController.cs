...
{
    public class VisitorDivisionController : ApiController
    {
        [HttpPost]
        [ValidateModel]
        [Route("api/getDivisionlistforvisitor")]
        public HttpResponseMessage GetDetails(ListDivisionVisitor ula)
        {
            ...
            if (ula.ExId != 0)
            {
                try
                {
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        while (dr.Read())
                        {
                            alldcr1.Add(new GetDivisionVisitor
                            {
                        ...
                        g1.close_connection();
                        alldcr.Add(new GetDivisionVisitors
                        {
                            result = true,
