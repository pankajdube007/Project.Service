...
{
    public class GetItemDetailsByItemCodeController : ApiController
    {
        ...
        [Route("api/getItemDetailsByItemCode")]
        public HttpResponseMessage GetDetails(ListofGetItemDetailsByItemCode ula)
        {
            ...
            if (ula.CIN != "")
            {
                try
                {
                    ...
                    List<GetItemDetailsByItemCodeLists> alldcr = new List<GetItemDetailsByItemCodeLists>();
                    List<GetItemDetailsByItemCodeList> alldcr1 = new List<GetItemDetailsByItemCodeList>();
                    var dr = g1.return_dr("GetItemListByItemCode '" + ula.ItemCode + "','" + ula.CIN + "','" + ula.CategoryID + "'");

                    if (dr.HasRows)
                    {
                        while (dr.Read())
                        {
                            alldcr1.Add(new GetItemDetailsByItemCodeList
                            {
                        ...
                        g1.close_connection();
                        alldcr.Add(new GetItemDetailsByItemCodeLists
                        {
                            result = true,
