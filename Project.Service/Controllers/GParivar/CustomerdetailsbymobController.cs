                    ...
                    if (dr.HasRows)
                    {
                        while (dr.Read())
                        {
                            alldcr1.Add(new CustomerDetailByMobList
                            {
                                ...
                                UserStatus = Convert.ToString(dr["CurrentStatus"].ToString()),
                                UserCashback = Convert.ToString(dr["TotalCashback"].ToString()),
                                RRP = Convert.ToString(dr["rrp"].ToString()),
                                DRP = Convert.ToString(dr["drp"].ToString()),
                                LastScanAmount = Convert.ToString(dr["LastScanAmount"].ToString()),
                                LastScanDt = Convert.ToString(dr["Lastscandt"].ToString()),
