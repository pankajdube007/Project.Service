...
namespace Project.Service.Controllers
{
    ...
    public class ItemDetailsByCategoryAndNameOrCodeController : ApiController
    {
        ...
        [Route("api/getitemDetailsByCategoryAndNameorCodeDetailList")]
        public HttpResponseMessage GetDetails(ListofItemDetailsByCategoryAndNameOrCode ula)
        {
            ...
            if (ula.CIN != "")
            {
                try
                {
                    ...
                    List<ItemDetailsByCategoryAndNameOrCodeLists> alldcr = new List<ItemDetailsByCategoryAndNameOrCodeLists>();
                    List<ItemDetailsByCategoryAndNameOrCodeList> alldcr1 = new List<ItemDetailsByCategoryAndNameOrCodeList>();
                    var dr = g1.return_dr("ItemDetailsByCategoryAndNameOrCodeDetailList '" + ula.CIN + "','" + ula.CategoryID + "','" + ula.ItemSearchText + "'");

                    if (dr.HasRows)
                    {
                        while (dr.Read())
                        {
                            alldcr1.Add(new ItemDetailsByCategoryAndNameOrCodeList
                            {
                        ...
                        g1.close_connection();
                        alldcr.Add(new ItemDetailsByCategoryAndNameOrCodeLists
                        {
                            result = true,
