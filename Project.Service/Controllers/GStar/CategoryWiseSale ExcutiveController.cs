                    ...
                    if (dr.Rows.Count > 0)
                    {
                        for (int i = 0; i < dr.Rows.Count; i++)
                        {
                            alldcr1.Add(new CategoryWiseEx
                            {
                                ...
                                FAN = Math.Round(Convert.ToDecimal(dr.Rows[i]["FAN"]), 0).ToString(),
                            });
                            ...
                            FANtotal = FANtotal + Convert.ToDecimal(dr.Rows[i]["FAN"]);
                        }
                        ...
                        Total.Add(new CategoryWiseTotalEx
                        {
                            ...
                            FANtotal = Math.Round(FANtotal, 0).ToString()
                        });
