...
{
    public class DummySignUpVendorController : ApiController
    {
        [HttpPost]
        [ValidateModel]
        [Route("api/getdummysignupvendor")]
        public HttpResponseMessage GetDetails(ActionResultPartyDummyVendor ula)
        {
            ...
            if (ula.Name != "")
            {
                try
                {
                    ...
                    List<UserValidationPartyDummyVendor.UserInfoDummyVendor> user = new List<UserValidationPartyDummyVendor.UserInfoDummyVendor>();

                    var dt1 = g1.return_dt("dummysignupvendornew '" + ula.Name + "','" + ula.LastName + "','" + ula.Email + "','" + ula.Password + "'");
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        List<UserValidationPartyDummyVendor.UserInfoDummyVendor> userDummy = new List<UserValidationPartyDummyVendor.UserInfoDummyVendor>();
                        ...
                        user.Add(new UserValidationPartyDummyVendor.UserInfoDummyVendor
                        {
                            result = true,
                            message = "",
                            servertime = DateTime.Now.ToString(),
                            data = new UserValidationPartyDummyVendor.UsersDummyVendor
                            {
